...
feature.vars <- c("Temp","Prec","imperv45km","Population","megachilidae","tcc45km","area_km2","Median_HH_Income","BA_Population")
city.data <- city.data %>%
  rename(unit.no = ID)
...
gbifcity_out <- city.data %>%
  ...
  synthetic_control(outcome = megachilidae, # outcome
...
```{r}
gbifcity_out %>% grab_significance()
