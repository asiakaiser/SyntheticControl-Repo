...
its.plot <- ggplot(city.data.its,
  ...
  geom_line(aes(year,counter.predictions),color='#D55E00',lty=1)+
  geom_ribbon(aes(ymin = its.predictions - (1.96*its.se), ymax = its.predictions + (1.96*its.se)), fill = '#56B4E9', alpha = 0.2, linetype = 2)+
  geom_line(aes(year,its.predictions),color='#56B4E9',lty=2)+
    geom_vline(xintercept = 2021, linetype="dashed")+
  geom_point()+
