...
ba.model <- lm(nobs45km ~ 1 + Treatment, data = city.data.ba)
summary(ba.model)
...
ba.plot <- ggplot(city.data.ba, aes(x = year, y = nobs45km)) +
  ...
  geom_point(color = "darkgrey")+
    geom_point(aes(x = 2017.5, y = ba.model$coefficients[1], color = "#8B0000", group = 1))+
        geom_errorbar(aes(x = 2017.5, ymin = confint.ba[1], ymax = confint.ba[3], color = "#8B0000"), width = 0.25)+
    geom_point(aes(x = 2021.5, y = ba.model$coefficients[2], color = "#8B0000", group = 1))+
    geom_errorbar(aes(x = 2021.5, ymin = confint.ba[2], ymax = confint.ba[4], color = "#8B0000"), width = 0.25)+
...
baci.model <- lmer(nobs45km ~ Treated * Time + (1|City), data = city.data.baci)
