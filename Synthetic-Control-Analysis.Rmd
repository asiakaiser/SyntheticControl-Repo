...
(decline.2023 <- ((340.878- 299)/340.878)*100)
(decline.2022 <- ((291.089-238)/291.089)*100) 
=======
>>>>>>> 1bfb87fa280521ecea5a25a48a7dc59a0b0d6fa2
```
...
scpi.plot <- ggplot(scpi.data, aes(x = year, y = nobs45km, color = Treatment)) +
  ...
  geom_point()+
    geom_point(aes(x = 2022, y = 291.089, color = "#c443b2", group = 1))+
        geom_errorbar(aes(x = 2022, ymin = 276.048, ymax = 340.897, color = "#c443b2"), width = 0.25)+
    geom_point(aes(x = 2023, y = 340.878, color = "#c443b2", group = 1))+
    geom_errorbar(aes(x = 2023, ymin = 332.277, ymax = 390.306, color = "#c443b2"), width = 0.25)+
